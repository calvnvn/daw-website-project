...
export default function Hero() {
  ...
  // useEffect khusus untuk Parallax
  useEffect(() => {
  ...
  // useEffect khusus untuk Auto-Play
  useEffect(() => {
  ...
  const handleScrollDown = () => {
    // Tombol ini sekarang fokus hanya untuk animasi scroll ke bawah
  ...
  return (
    <section className="relative h-screen min-h-[600px] w-full overflow-hidden bg-slate-900">
      ...
      {displaySlides.map((slide, index) => (
        ...
        >
          {/* Layer ini khusus bergerak vertikal mengikuti scroll (Tanpa transition lambat) */}
          <div
          ...
          >
            {/* LAYER ZOOM */}
            {/* Layer ini khusus membesar pelan-pelan (10 detik) menggunakan Tailwind */}
            <div
              className={`absolute inset-0 w-full h-[110%] -top-[5%] bg-cover bg-center bg-no-repeat transition-transform duration-[10000ms] ease-out ${
