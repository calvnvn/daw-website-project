...
## 4. Backend Workflows & The Notification Engine
...
- **Frontend**: Always use the `@/` alias mapped to `daw-frontend/src`.
  - _Example_: `import { Button } from "@/components/ui/button";`
  - _Example_: `import HeroManager from "@/components/admin/home/HeroManager";`
...
- _Example_: `refactor: reorganize admin folder structure by domain`
